...
export function AppRouter(){return <BrowserRouter><Routes>
  ...
  <Route path="/doctor" element={protectedRole("doctor",DoctorLayout)}><Route index element={<Navigate to="dashboard" replace/>}/><Route path="dashboard" element={<Doctor.Dashboard/>}/><Route path="emergencies" element={<Doctor.Emergencies/>}/><Route path="patients" element={<Doctor.Patients/>}/><Route path="patient/:id" element={<Doctor.PatientDetail/>}/><Route path="prescriptions" element={<Doctor.Prescriptions/>}/><Route path="orders" element={<Doctor.Orders/>}/><Route path="ambulances" element={<Doctor.Ambulances/>}/><Route path="beds" element={<Doctor.Beds/>}/><Route path="pharmacy" element={<Doctor.Pharmacy/>}/><Route path="reports" element={<Doctor.Reports/>}/></Route>
